...
const getBooks = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, utils_1.APIResponse)(response, books, "All books", 200);
});
...
const getBookById = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (book) {
        (0, utils_1.APIResponse)(response, book, "Book found", 200);
    }
    else {
        (0, utils_1.APIResponse)(response, null, "Book not found", 404);
    }
});
...
const addBook = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, utils_1.APIResponse)(response, newBook, "Book created", 201);
});
exports.addBook = addBook;
const deleteBookById = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = request.params;
    yield (0, book_models_1.deleteBook)(id);
    (0, utils_1.APIResponse)(response, null, "Book deleted", 204);
});
exports.deleteBookById = deleteBookById;
const updateBookById = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = request.params;
    const { book } = request.body;
    yield (0, book_models_1.updateBook)(id, book);
    (0, utils_1.APIResponse)(response, book, "Book updated", 200);
});
