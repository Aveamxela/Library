...
const getUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, utils_1.APIResponse)(res, users, "List of all users", 200);
    }
    catch (error) {
        utils_1.logger.error(`Erreur lors de la récupération des utilisateurs: ${error.message}`);
        (0, utils_1.APIResponse)(res, null, error.message, 500);
    }
});
...
const getUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        (0, utils_1.APIResponse)(res, user, "User found");
    }
    else {
        (0, utils_1.APIResponse)(res, null, "User not found", 404);
    }
});
